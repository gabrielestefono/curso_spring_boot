...
public class User implements UserDetails, Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((accountNotExpired == null) ? 0 : accountNotExpired.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (accountNotExpired == null) {
			if (other.accountNotExpired != null)
				return false;
		} else if (!accountNotExpired.equals(other.accountNotExpired))
			return false;
